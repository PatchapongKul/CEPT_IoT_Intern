...
{
    if (packetType == getByteByName(PACKET_TYPE, PACKET_TYPE_MAP, sizeof(PACKET_TYPE), "COMMAND"))
    {                                      // type: command
    ...
    else if (packetType == getByteByName(PACKET_TYPE, PACKET_TYPE_MAP, sizeof(PACKET_TYPE), "REPLY"))
    {                                      // type: reply
...
void ToshibaCarrierHvac::sendHandshake(void)
{
    ...
    else if (_handshake && !_connected && !_ready)
    { // when received syn/ack then send ack
...
{
    if (strcasecmp(wantedSettings.state, userSettings.state) != 0)
    { // state
        wantedSettings.state = userSettings.state;
        byte data[2];
        data[0] = getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "STATE");
        data[1] = getByteByName(STATE_BYTE, STATE_BYTE_MAP, sizeof(STATE_BYTE), wantedSettings.state);
    ...
    if (wantedSettings.setpoint != userSettings.setpoint)
    { // setpoint
        ...
        else if (userSettings.setpoint < 17)
        { // if value lower then minimun set to minimun
#ifdef HVAC_DEBUG
        ...
        else if (userSettings.setpoint > 30)
        { // if value higher then maximun set to maximum
#ifdef HVAC_DEBUG
    ...
    if (strcasecmp(wantedSettings.mode, userSettings.mode) != 0)
    { // mode
    ...
    if (strcasecmp(wantedSettings.swing, userSettings.swing) != 0)
    { // swing
    ...
    if (strcasecmp(wantedSettings.fanMode, userSettings.fanMode) != 0)
    { // fan mode
    ...
    if (strcasecmp(wantedSettings.pure, userSettings.pure) != 0)
    { // pure
    ...
    if (strcasecmp(wantedSettings.powerSelect, userSettings.powerSelect) != 0)
    { // power select
    ...
    if (strcasecmp(wantedSettings.operation, userSettings.operation) != 0)
    { // operation
    ...
    if (strcasecmp(wantedSettings.wifiLed, userSettings.wifiLed) != 0)
    { // wifi led
        ...
        { // wifi led 2
            ...
            data[1] = getByteByName(WIFILED2_BYTE, WIFILED2_BYTE_MAP, sizeof(WIFILED2_BYTE), wantedSettings.wifiLed);
        }
    ...
    if (strcasecmp(wantedSettings.selfclean, userSettings.selfclean) != 0) // selfclean
    {
        wantedSettings.selfclean = userSettings.selfclean;
        byte data[2];
        data[0] = getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "SELFCLEANING");
        data[1] = getByteByName(SELFCLEAN_BYTE, SELFCLEAN_BYTE_MAP, sizeof(SELFCLEAN_BYTE), wantedSettings.selfclean);
        createPacket(PACKET_HEADER, sizeof(PACKET_HEADER), 16, data, sizeof(data));
#ifdef HVAC_DEBUG
        DEBUG_PORT.print(F("HVAC> User wanted State-> "));
        DEBUG_PORT.println(wantedSettings.state);
...
{
    if (dataLen == 5)
    { // process data group 1 - basic (mode, setpoint, fanmode, operation)
    ...
    { // process single data
...
#endif
        // connection status
        if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "STATUS"))
        { // status
#ifdef HVAC_DEBUG
        ...
        { // process data when connected
            if ((data[0] == 187) || (data[0] == 190) || (data[0] == 144) || (data[0] == 148))
            { // status
                hvacStatus receiveStatus;
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "ROOMTEMP"))
                { // room temperature
#ifdef HVAC_DEBUG
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "OUTSIDETEMP"))
                { // outside temperature and cdu state
#ifdef HVAC_DEBUG
...
#endif
                    if (receiveStatus.outsideTemperature == 127)
                    { // cdu not running, not update outside temperature and update cdu state
#ifdef HVAC_DEBUG
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "OFFTIMER"))
                { // off timer
#ifdef HVAC_DEBUG
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "ONTIMER"))
                { // on timer
#ifdef HVAC_DEBUG
            ...
            { // setting
                hvacSettings receiveSettings;
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "STATE"))
                { // state
#ifdef HVAC_DEBUG
                    DEBUG_PORT.print(F("State-> "));
#endif
                    receiveSettings.state = getNameByByte(STATE_BYTE_MAP, STATE_BYTE, sizeof(STATE_BYTE), data[1]);
#ifdef HVAC_DEBUG
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "SETPOINT"))
                { // setpoint
#ifdef HVAC_DEBUG
                    DEBUG_PORT.print(F("Setpoint-> "));
#endif
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "MODE"))
                { // mode
#ifdef HVAC_DEBUG
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "SWING"))
                { // swing
#ifdef HVAC_DEBUG
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "FANMODE"))
                { // fan mode
#ifdef HVAC_DEBUG
                    DEBUG_PORT.print(F("Fanmode-> "));
#endif
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "PURE"))
                { // pure
#ifdef HVAC_DEBUG
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "PSEL"))
                { // power select
#ifdef HVAC_DEBUG
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "OP"))
                { // operation
#ifdef HVAC_DEBUG
                    DEBUG_PORT.print(F("Operation-> "));
#endif
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "WIFILED2"))
                { // wifi led 2
                    _wifiled = true;
#ifdef HVAC_DEBUG
                    DEBUG_PORT.print(F("WifiLED2-> "));
#endif
                    receiveSettings.wifiLed = getNameByByte(WIFILED2_BYTE_MAP, WIFILED2_BYTE, sizeof(WIFILED2_BYTE), data[1]);
#ifdef HVAC_DEBUG
                    DEBUG_PORT.println(receiveSettings.wifiLed);
#endif
                    if (currentSettings.wifiLed != receiveSettings.wifiLed)
                ...
                if (data[0] == getByteByName(FUNCTION_BYTE, FUNCTION_BYTE_MAP, sizeof(FUNCTION_BYTE), "SELFCLEANING"))
                {                           // state
                    debug_selfcleaning = 1; // enable selfcleaning debug
#ifdef HVAC_DEBUG
                    DEBUG_PORT.print(F("selfclean-> "));
#endif
                    receiveSettings.selfclean = getNameByByte(SELFCLEAN_BYTE_MAP, SELFCLEAN_BYTE, sizeof(SELFCLEAN_BYTE), data[1]);
#ifdef HVAC_DEBUG
                    DEBUG_PORT.println(receiveSettings.selfclean);
#endif
                    if (currentSettings.selfclean != receiveSettings.selfclean)
                    {
                        if (settingsUpdatedCallback)
                        {
                            wantedSettings.selfclean = userSettings.selfclean = currentSettings.selfclean = receiveSettings.selfclean;
                            _settingsCallbackBucket++;
                            _lastSettingsCallback = millis();
                            return true;
                        }
        ...
        { // received data when not connected
#ifdef HVAC_DEBUG
...
{
    if (data[3] == getByteByName(PACKET_TYPE, PACKET_TYPE_MAP, sizeof(PACKET_TYPE), "FEEDBACK"))
    { // feedback
        ...
        if (data[4] > MAX_FEEDBACK_COUNT)
        { // query temperature after received x feedback(s) to avoid front panel blinking.
#ifdef HVAC_DEBUG
    ...
    else if (data[3] == getByteByName(PACKET_TYPE, PACKET_TYPE_MAP, sizeof(PACKET_TYPE), "REPLY"))
    { // reply
    ...
    else if (data[3] == getByteByName(PACKET_TYPE, PACKET_TYPE_MAP, sizeof(PACKET_TYPE), "SYN/ACK"))
    { // syn/ack
#ifdef HVAC_DEBUG
    ...
    else if (data[3] == getByteByName(PACKET_TYPE, PACKET_TYPE_MAP, sizeof(PACKET_TYPE), "ACK"))
    { // ack
#ifdef HVAC_DEBUG
...
bool ToshibaCarrierHvac::chunkSplit(byte data[], size_t dataLen)
{
    ...
    if (!_ready && !_connected)
        _start = start = findHeaderStart(data, dataLen, HANDSHAKE_HEADER, sizeof(HANDSHAKE_HEADER));
    else
        _start = start = findHeaderStart(data, dataLen, PACKET_HEADER, sizeof(PACKET_HEADER));
    if (start == 255)
    {
...
bool ToshibaCarrierHvac::packetMonitor(void)
{
    ...
    { // if received 1st data then continue to read rest of data until timeout
        ...
        // Edited
        // rxBufferLength = dataLen;

#ifdef HVAC_DEBUG
        if ((MAX_RX_BYTE_READ - dataLen) < 1)
            DEBUG_PORT.println(F("HVAC> Serial buffer almost full"));
        ...
        if ((dataLen == 15) && (dataLen == 17) && findHeader(rxBuffer, dataLen, PACKET_HEADER, sizeof(PACKET_HEADER)))
        {
            ...
            return chunkSplit(rxBuffer, dataLen);
    }
    else
        return false;
}
...
{
    byte fn[12] = {128, 135, 144, 148, 163, 187, 190, 199, 222, 223, 248, 203};
...
// void ToshibaCarrierHvac::setSelfclean(const char *newSelfclean)
// {
//     userSettings.selfclean = newSelfclean;
// }
...
const char *ToshibaCarrierHvac::getSelfclean(void)
{
    return currentSettings.selfclean;
}
...
bool ToshibaCarrierHvac::isHandshaked(void)
{
    return _handshake;
}
...
// const byte* ToshibaCarrierHvac::getRxBuffer(void) {
//     return rxBuffer;
// }

// size_t ToshibaCarrierHvac::getRxBufferLength(void) {
